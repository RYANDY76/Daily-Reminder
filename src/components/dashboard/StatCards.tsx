  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
      <div className="card p-4 relative overflow-hidden isolate">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-500 relative">{t('dashboard.totalTasks')}</p>
      </div>
      <div className="card p-4 relative overflow-hidden isolate border-primary-100 dark:border-primary-800/20">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-500 relative">{t('stats.done')}</p>
      </div>
      <div className="card p-4 relative overflow-hidden isolate">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-500 relative">{t('task.pending')}</p>
      </div>
      <div className="card p-4 relative overflow-hidden isolate">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-500 relative">{t('task.missed')}</p>
      </div>
    </div>
  )
}
