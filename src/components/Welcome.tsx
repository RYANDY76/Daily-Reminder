...
import { CheckCircle2, Sparkles, ArrowRight, UserPlus, LogIn, Target, Timer, BarChart3 } from 'lucide-react'
      ...
      <div className="min-h-screen flex flex-col bg-white dark:bg-dark-bg">
        <div className="relative overflow-hidden bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 px-6 pt-16 pb-12 text-white text-center">
          ...
          <div className="relative">
            ...
            <p className="text-primary-100 text-base leading-relaxed max-w-xs mx-auto">{t('welcome.subtitle')}</p>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-dark-bg">
      <div className="h-1 bg-gray-100 dark:bg-dark-card">
        <div className="h-full bg-primary-500 transition-all duration-500" style={{ width: '50%' }} />
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('welcome.createAccount')}</h2>
            <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">{t('welcome.createAccountDesc')}</p>
          </div>

          <div className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">{t('profile.nameLabel')}</label>
              <input
                type="text"
                value={name}
            ...
            <label className="flex items-start gap-3 p-4 rounded-xl border-2 border-gray-200 dark:border-dark-border cursor-pointer hover:border-primary-300 dark:hover:border-primary-700 transition-colors">
              ...
              />
              <span className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{t('welcome.consentLabel')}</span>
            </label>
